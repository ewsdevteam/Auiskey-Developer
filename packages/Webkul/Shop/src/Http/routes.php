...
Route::group(['middleware' => ['web', 'locale', 'theme', 'currency']], function () {
    ...
    Route::post('/max_bid','Webkul\Shop\Http\Controllers\OnepageController@get_max_bid')->name('get_max_bid');    
    //get products for shop by category     
    Route::get('/shopProducts','Webkul\Shop\Http\Controllers\ProductsCategoriesProxyController@shopProducts')->name('shop.products');    
    //subscription
    ...
    Route::get('/news', 'Webkul\Shop\Http\Controllers\HomeController@news')->name('shop.news');

    Route::get('/app', 'Webkul\Shop\Http\Controllers\HomeController@app')->name('shop.app');
    
    Route::get('/about', 'Webkul\Shop\Http\Controllers\HomeController@about')->name('shop.about');
    ...
    Route::get('checkout/thankyou',function(){
        return view('shop::custom-pages.thankyou');
    })->name('thank-you');
    ...
    //Checkout Save Bid
    Route::post('/checkout/save-bid-price', 'Webkul\Shop\Http\Controllers\OnepageController@saveBidPrice')->name('shop.checkout.save-bid-price');
    
    //Checkout Save Bid
    Route::post('/checkout/save-bid', 'Webkul\Shop\Http\Controllers\OnepageController@saveBid')->name('shop.checkout.save-bid');
        ...
        Route::group(['middleware' => ['customer']], function () {
            ...
            Route::prefix('account')->group(function () {
                ...
                Route::get('profile', 'Webkul\Customer\Http\Controllers\CustomerController@index')->defaults('_config', [
                    'view' => 'shop::customers.account.profile.customer-dashboard.index'
                ])->name('customer.profile.index');

                Route::get('/security', function(){
                    return view('shop::customers.account.profile.customer-dashboard.security');
                })->name('customer.profile.security');

                Route::get('/buying', function(){
                    return view('shop::customers.account.profile.customer-dashboard.buying');
                })->name('customer.profile.buying');
                ...
                Route::get('/selling', function(){
                    return view('shop::customers.account.profile.customer-dashboard.selling');
                })->name('customer.profile.selling');

                Route::get('/following', function(){
                    return view('shop::customers.account.profile.customer-dashboard.following');
                })->name('customer.profile.following');

                Route::get('/portfolio', function(){
                    return view('shop::customers.account.profile.customer-dashboard.profile');
                })->name('customer.profile');

                Route::get('/setting', function(){
                    return view('shop::customers.account.profile.customer-dashboard.setting');
                })->name('customer.profile.setting');
                ...
                Route::post('profile/destroy', 'Webkul\Customer\Http\Controllers\CustomerController@destroy')->defaults('_config', [
                    'redirect' => 'customer.session.create'
                ...
                Route::get('bids', 'Webkul\Shop\Http\Controllers\OrderController@bids')->defaults('_config', [
                    'view' => 'shop::customers.account.bids.index'
                ])->name('customer.profile.bids');
