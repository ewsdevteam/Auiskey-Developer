    ...
    Route::prefix(config('app.admin_url'))->group(function () {
        ...
        Route::group(['middleware' => ['admin']], function () {
            ...
            Route::prefix('news')->group(function () {
                //news
                Route::get('/news', 'Webkul\Blog\Http\Controllers\BlogController@index')->defaults('_config', [
                    'view' => 'admin::news.index',
                ])->name('admin.news.index');

                Route::get('news/create', 'Webkul\Blog\Http\Controllers\BlogController@create')->defaults('_config', [
                    'view' => 'admin::news.create',
                ])->name('admin.news.create');

                Route::post('news/create', 'Webkul\Blog\Http\Controllers\BlogController@store')->defaults('_config', [
                    'redirect' => 'admin.news.index',
                ])->name('admin.news.store');

                Route::get('news/edit/{id}', 'Webkul\Blog\Http\Controllers\BlogController@edit')->defaults('_config', [
                    'view' => 'admin::news.edit',
                ])->name('admin.news.edit');

                Route::post('news/update/{id}', 'Webkul\Blog\Http\Controllers\BlogController@update')->defaults('_config', [
                    'redirect' => 'admin.news.index',
                ])->name('admin.news.update');

                Route::get('news/delete/{id}', 'Webkul\Blog\Http\Controllers\BlogController@destroy')->defaults('_config', [
                    'redirect' => 'admin.news.index',
                ])->name('admin.news.delete');

                Route::post('news/mass_delete', 'Webkul\Blog\Http\Controllers\BlogController@massDestroy')->defaults('_config', [
                    'redirect' => 'admin.news.index',
                ])->name('admin.news.massdelete');

                Route::get('/reviews', 'Webkul\Blog\Http\Controllers\BlogController@reviews')->defaults('_config', [
                    'view' => 'admin::news.reviews.index',
                ])->name('admin.news.reviews.index');
                
                Route::get('/reviews/edit/{id}', 'Webkul\Blog\Http\Controllers\BlogController@review_edit')->defaults('_config', [
                    'view' => 'admin::news.reviews.edit',
                ])->name('admin.news.reviews.edit');
                
                Route::put('/reviews/update/{id}', 'Webkul\Blog\Http\Controllers\BlogController@review_update')->defaults('_config', [
                    'redirect' => 'admin.news.reviews.index',
                ])->name('admin.news.reviews.update');
                
                Route::get('/reviews/delete/{id}', 'Webkul\Blog\Http\Controllers\BlogController@review_delete')->defaults('_config', [
                    'redirect' => 'admin.news.reviews.index',
                ])->name('admin.news.reviews.delete');
                
                //Blogs Categories
                // Route::get('/categories', 'Webkul\Category\Http\Controllers\BlogCategoryController@index')->defaults('_config', [
                //     'view' => 'admin::blog.categories.index',
                // ])->name('admin.blog.categories.index');

                // Route::get('/categories/create', 'Webkul\Category\Http\Controllers\BlogCategoryController@create')->defaults('_config', [
                //     'view' => 'admin::blog.categories.create',
                // ])->name('admin.blog.categories.create');

                // Route::post('/categories/create', 'Webkul\Category\Http\Controllers\BlogCategoryController@store')->defaults('_config', [
                //     'redirect' => 'admin.blog.categories.index',
                // ])->name('admin.blog.categories.store');

                // Route::get('/categories/edit/{id}', 'Webkul\Category\Http\Controllers\BlogCategoryController@edit')->defaults('_config', [
                //     'view' => 'admin::blog.categories.edit',
                // ])->name('admin.blog.categories.edit');

                // Route::put('/categories/edit/{id}', 'Webkul\Category\Http\Controllers\BlogCategoryController@update')->defaults('_config', [
                //     'redirect' => 'admin.blog.categories.index',
                // ])->name('admin.blog.categories.update');

                // Route::post('/categories/delete/{id}', 'Webkul\Category\Http\Controllers\BlogCategoryController@destroy')->name('admin.blog.categories.delete');
