...
return [
    ...
    'news' => [
        'news' => [
            'title' => 'News',
            'add-news-btn-title' => 'Add News',
            'add-title' => 'Add News',
            'edit-title' => 'Edit News',
            'save-btn-title' => 'Save News',
            'general' => 'General',
            'product-type' => 'Product Type',
            'simple' => 'Simple',
            'configurable' => 'Configurable',
            ...
            'variant-already-exist-message' => 'Variant with same attribute options already exists.',
            'add-image-btn-title' => 'Add Image',
            'mass-delete-success' => 'All the selected news have been deleted successfully',
            'mass-update-success' => 'All the selected news have been updated successfully',
            'configurable-error' => 'Please select atleast one configurable attribute.',
            'categories' => 'Categories',
            'images' => 'Images',
            'inventories' => 'Inventories',
            ...
            'sort-order' => 'Sort Order',
            'browse-file' => 'Browse File',
            'news-link' => 'Linked News',
            'cross-selling' => 'Cross Selling',
            'up-selling' => 'Up Selling',
            'related-news' => 'Related News',
            'news-search-hint' => 'Start typing news name',
            'no-result-found' => 'News not found with same name.',
            'searching' => 'Searching ...',
            'grouped-products' => 'Grouped Products',
