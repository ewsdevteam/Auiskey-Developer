...
@section('page_title')
    {{ __('admin::app.catalog.services.edit-title') }}
@stop
            ...
            <div class="page-header">
                ...
                <div class="page-action">
                    <button type="submit" class="btn btn-lg btn-primary">
                        {{ __('admin::app.catalog.services.save-btn-title') }}
                    </button>
                </div>
            </div>
                        ...
                        <accordian :title="'{{ __($attributeGroup->name) }}'"
                            ...
                            <div slot="body">
                                ...
                                @foreach ($customAttributes as $attribute)
                                    ...
                                    <?php
                                        if ($attribute->code == 'new' || $attribute->code == 'featured' || $attribute->code == 'color' || $attribute->code == 'size' ){
                                            continue;
                                        }
