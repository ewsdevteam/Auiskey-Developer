...
@section('page_title')
    {{ __('admin::app.news.news.add-title') }}
@stop

@section('content')
    <div class="content">

        <form method="POST" action="{{ route('admin.news.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
                    ...
                    <accordian :title="'{{ __('admin::app.catalog.categories.general') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('title') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="name" name="title" value="{{ old('title') }}" data-vv-as="&quot;{{ __('admin::app.news.news.name') }}&quot;" v-slugify-target="'slug'"/>
                    ...
                    {{--<accordian :title="'{{ __('admin::app.catalog.categories.filterable-attributes') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('attributes[]') ? 'has-error' : '']">
                                ...
                                <select class="control" name="attributes[]" v-validate="" data-vv-as="&quot;{{ __('admin::app.catalog.categories.attributes') }}&quot;" multiple>
